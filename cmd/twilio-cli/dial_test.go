...
func withFakeMic(t *testing.T, fn func(ctx context.Context, conn *websocket.Conn, streamSID string, seqNum *int, onMicWarm func()) error) {
	t.Helper()
	original := streamMic
	streamMic = fn
...
func TestDial_NoStopFrameOnServerClose(t *testing.T) {
	...
	withFakeMic(t, func(ctx context.Context, _ *websocket.Conn, _ string, _ *int, _ func()) error {
		<-ctx.Done()
		return ctx.Err()
	})
...
func blockingMic(ctx context.Context, _ *websocket.Conn, _ string, _ *int, _ func()) error {
	<-ctx.Done()
	return ctx.Err()
}
...
func TestCLI_CallerHangup(t *testing.T) {
	withFakeMic(t, func(ctx context.Context, conn *websocket.Conn, streamSID string, _ *int, _ func()) error {
