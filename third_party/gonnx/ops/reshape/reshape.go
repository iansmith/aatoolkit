...
// Init initializes the reshape operator. Reshape gained the 'allowzero' attribute
// in opset 14; gonnx implements only the opset-13 default (allowzero=0), so a
// non-zero value — or any other attribute — is rejected rather than silently
// ignored.
func (r *Reshape) Init(n *onnx.NodeProto) error {
