...
import (
	...
	"github.com/advancedclimatesystems/gonnx/ops/ifop"
	...
	"github.com/advancedclimatesystems/gonnx/ops/pad"
	...
	"github.com/advancedclimatesystems/gonnx/ops/size"
...
const (
	MinSupportedOpset = 7
	// MaxSupportedOpset is 16 so that opset-16 models (e.g. Silero VAD) load. No
	// operator registers a version above 13, so GetClosestOperatorVersion still
	// resolves the same <=13 implementations; the post-13 attribute guards in the
	// individual operators' Init turn any newer semantics into a loud error rather
	// than silent misexecution.
	MaxSupportedOpset = 16
)
